...
export const defaultTemplates: TemplateDef[] = [
  ...
  {
    id: "healthcare",
    name: { ar: "رعاية صحية", en: "Healthcare" },
    description: {
      ar: "قالب هادئ للقطاع الصحي والتمريض والصيدلة، يبرز التراخيص والشهادات والمسؤوليات السريرية بوضوح.",
      en: "A calm clinical layout for healthcare, nursing and pharmacy that elevates licenses, certifications and clinical duties.",
    },
    category: "ats",
    atsFriendly: true,
    supportsRTL: true,
  ...
  {
    id: "education",
    name: { ar: "تعليم وأكاديميا", en: "Education & Academia" },
    description: {
      ar: "تنسيق أكاديمي مرتب للمعلمين والباحثين، يقدّم التعليم والمنشورات والشهادات قبل الخبرات الثانوية.",
      en: "An academic-friendly layout for teachers and researchers that foregrounds education, publications and credentials.",
    },
    category: "executive",
    atsFriendly: true,
    supportsRTL: true,
  ...
  {
    id: "hospitality",
    name: { ar: "ضيافة وخدمات", en: "Hospitality & Service" },
    description: {
      ar: "هوية دافئة لقطاع الضيافة والسياحة وخدمة العملاء، مع قراءة بشرية ممتازة وقسم مهارات بارز.",
      en: "A warm identity for hospitality, tourism and customer service with excellent human scanning and a prominent skills block.",
    },
    category: "modern",
    atsFriendly: false,
    supportsRTL: true,
  ...
  {
    id: "operations",
    name: { ar: "عمليات ولوجستيات", en: "Operations & Logistics" },
    description: {
      ar: "قالب عملي مضغوط للعمليات والمشتريات واللوجستيات، يركز على الأرقام والمسؤوليات التشغيلية.",
      en: "A compact operational layout for ops, procurement and logistics that emphasizes metrics and ownership.",
    },
    category: "ats",
    atsFriendly: true,
    supportsRTL: true,
