...
export const defaultTemplates: TemplateDef[] = [
  ...
  },
  {
    ...
    description: {
      ar: "قالب عربي أولاً بترويسة خضراء وعمود جانبي منظم للمهارات واللغات والروابط.",
      en: "Arabic-first profile with green banner and an organized sidebar for skills, languages and links.",
    },
    category: "modern",
    atsFriendly: true,
    supportsRTL: true,
  ...
  },
  {
    ...
    description: {
      ar: "تنسيق مهني نظيف مناسب للسوق الخليجي، مع عمود جانبي خفيف دون ازدحام بصري.",
      en: "A polished GCC-oriented profile with a light sidebar and restrained hierarchy.",
    },
    category: "modern",
    atsFriendly: true,
    supportsRTL: true,
